...
\begin{enumerate}
	...
	\end{itemize}
	\item PV explanation and justify assumptions about weather influences
	\item Data processing and validation, weather interpolation, sanity checks
	\item What influences the PV production and why
\end{enumerate}
...
Using inverted distance weighting interpolation and linear regression we are able to determine the most crucial factors to electricity production.
